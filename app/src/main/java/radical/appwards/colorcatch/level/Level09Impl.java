...
public class Level09Impl implements Level {
	...
	public void myDraw(Canvas canvas) {
		canvas.drawText("Level 9", gv.screenW / 2, gv.whitePaint.getTextSize(),
