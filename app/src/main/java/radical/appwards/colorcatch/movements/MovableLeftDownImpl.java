...
public class MovableLeftDownImpl implements Movable, Serializable {
	...
	public MovableLeftDownImpl() {
		rect = new Rect();
	}

	public MovableLeftDownImpl(int s, int left, int top, int right, int bottom) {
		speed = s;
